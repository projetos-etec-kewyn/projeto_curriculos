            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">Habilidades</a>
                    ...
                    <div class="col-xl-10 col-lg-8 align-items-center">
                        <form action="altera_dados.php" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nome" id="nomeCompleto" placeholder="Digite seu novo nome" value="<?php echo $_SESSION['nome_user']?>">
                            </div>
                                    <label for="inputEmail4">Email</label>
                                    <input type="email" class="form-control" value="<?php echo $_SESSION['email_user']?>" id="inputEmail4" name="email" placeholder="Digite seu novo email">
                                <div class="form-group"><br>
                                    <label for="cpf">CPF</label>
                                   <input type="text" class="form-control form-control-user" id="exampleInputEmail"
                                        placeholder="CPF: Digite somente números" value="<?php echo $_SESSION['cpf_user']?>" name="cpf"
