...
<head> 
    ...
    <title>Banco de Curriculos - Register</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="criar.php" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail"
                                        placeholder="CPF: Digite somente números" name="cpf"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user" name="senha2"
                                            id="exampleRepeatPassword" placeholder="Repita a Senha">
                                    </div>
                                </div>
                                <label for="standard-select">
                                    <div class="select">
                                        <select name="tipo" id="standard-select" required>
                            ...
                            <!--<input name="telefone" type="text" id="telefone" placeholder="digite somente números" 
        onkeyup="mascara('###.###.###-##',this,event,true)" 
        maxlength="14">-->
                            <hr>
                            <div class="text-center">
